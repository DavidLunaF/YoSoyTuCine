...
ya que he divido 10 / 3 osea el col de 10 en cols de 3 no se...No zoy cientifico-->
            ...
            <div class="col-lg-10 col-xs-12"> <!-- Hasta el final es una col de 10 dividido en rows/filas de 5-->
                <div class="row primeraFilaDeInfoPeli">
                 <div class="col-lg-2 col-xs-12 infoPeli"> <!--infoPeli-->
                    <div class="DivInfoPeliCine">
                        <div class="infoPeliCine">
                ...
                <div class="col-lg-2 col-xs-12 infoPeli">
                    <!--infoPeli-->
                    <div class="DivInfoPeliCine">
                        <div class="infoPeliCine">
                ...
                <div class="row segundaFilaDeInfoPeli"><!--segunda fila loco-->
