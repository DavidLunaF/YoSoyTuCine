                        ...
                        <form novalidate="novalidate" id="formSignUp">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="email@ejemplo.com" name="emailSignUp" id="campoEmail" type="email" onchange="validaEmail()">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="password" name="passwordSignUp" id="campoPassword" type="password" onchange="validaPassword()">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="confirma password" name="passwordConfirmSignUp" onchange="validaConfirmaPassword()" id="campoConfirmaPassword" type="password">
                                </div>
                                <div id="resultadoConfirmaPassword"></div>
